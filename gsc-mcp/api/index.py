"""Vercel entry point — exposes the Google Search Console FastMCP ASGI app.
...
Mirrors ``meta-ads-mcp/api/index.py`` so the self-hosted MCPs deploy the same
way on Vercel.
"""
...
from mcp_gsc.server import mcp  # noqa: E402
