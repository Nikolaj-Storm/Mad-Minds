"""Vercel entry point — exposes the Google Ads FastMCP ASGI app.
...
Mirrors ``meta-ads-mcp/api/index.py`` so the two self-hosted MCPs deploy the
same way on Vercel.
"""
...
from gads_mcp.server import mcp  # noqa: E402
